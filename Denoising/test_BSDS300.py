...
if __name__ == '__main__':
    ...
    def test(model, test_loader):
        ...
        for i, data in enumerate(tqdm(test_loader)):
            ...
            if pw != 0:
                output = output[..., :, :-pw]
                noise_img = noise_img[...,:,:-pw]
            if ph != 0:
                output = output[..., :-ph, :]
                noise_img = noise_img[...,:-ph,:]
            output = output + 0.5
    ...
    eigennet = models.unet.UNet_n2n_un(in_channels=4, out_channels=3).cuda()
