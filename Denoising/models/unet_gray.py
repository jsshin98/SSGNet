...
class EigenNet3_lite(nn.Module):
    def __init__(self):
        super(EigenNet3_lite, self).__init__()
...
class EVNet3_lite_2(nn.Module):
    def __init__(self):
        super(EVNet3_lite_2, self).__init__()
...
class UNet_n2n_un(nn.Module):
    def __init__(self, in_channels=4, out_channels=4, opt=None):
        ...
        self.de_block5 = nn.Sequential(
            nn.Conv2d(96 + 1, 64, 3, padding=1, bias=True),
            nn.LeakyReLU(inplace=True, negative_slope=0.1),
